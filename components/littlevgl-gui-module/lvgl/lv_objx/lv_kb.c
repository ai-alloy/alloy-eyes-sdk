...
static const char * kb_map_lc[] = {
     "\204q", "\204w", "\204e", "\204r", "\204t", "\204y", "\204u", "\204i", "\204o", "\204p", "\207Del", "\n",
     "\203a", "\203s", "\203d", "\203f", "\203g", "\203h", "\203j", "\203k", "\203l", "\207Ent", "\n",
    "\223ABC","\2031#","_", "-", "z", "x", "c", "v", "b", "n", "m", ".", ",", ":", "\n",
...
static lv_res_t lv_kb_def_action(lv_obj_t * kb, const char * txt)
{
    ...
    else if(strcmp(txt, SYMBOL_CLOSE) == 0)  lv_ta_del_char(ext->ta);
