...
#define LV_INDEV_READ_PERIOD            80                     /*Input device read period in milliseconds*/
...
#define LV_FONT_DEFAULT        &myfont   /*Always set a default font from the built-in fonts*/
...
#  define LV_TA_PWD_SHOW_TIME     500    /*ms*/
#endif
