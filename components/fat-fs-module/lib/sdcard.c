...
{
    gpiohs_set_pin(SD_SPI_CS_FUNC_GPIOHS_NUM, GPIO_PV_HIGH);
}

void SD_CS_LOW(void)
{
    gpiohs_set_pin(SD_SPI_CS_FUNC_GPIOHS_NUM, GPIO_PV_LOW);
}
...
{
    gpiohs_set_drive_mode(SD_SPI_CS_FUNC_GPIOHS_NUM, GPIO_DM_OUTPUT);
