...
{
    gpiohs_set_drive_mode(LCD_DCX_FUNC_GPIOHS_NUM, GPIO_DM_OUTPUT);
    gpiohs_set_pin(LCD_DCX_FUNC_GPIOHS_NUM, GPIO_PV_HIGH);
}

static void set_dcx_control(void)
{
    gpiohs_set_pin(LCD_DCX_FUNC_GPIOHS_NUM, GPIO_PV_LOW);
}
...
{
    gpiohs_set_drive_mode(LCD_RST_FUNC_GPIOHS_NUM, GPIO_DM_OUTPUT);
    gpiohs_set_pin(LCD_RST_FUNC_GPIOHS_NUM, GPIO_PV_HIGH);
}

static void set_rst(uint8_t val)
{
    gpiohs_set_pin(LCD_RST_FUNC_GPIOHS_NUM, val);
}
